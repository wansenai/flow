<template>
  <BasicModal wrapClassName="bpmn-viewer-container" v-bind="$attrs" @register="registerModal" >
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(_, {emit}) {
      ...
      const [registerModal, { changeLoading, setModalProps }] = useModalInner(async (data) => {
