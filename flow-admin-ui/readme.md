...
server {
    ...
    location /flow-bpmn {
        try_files $uri $uri/ /flow-bpmn/index.html;
        root /home/wwwroot/default/;
        index /flow-bpmn/index.html;
    }
...
### 前端 部署到springboot后端
https://blog.csdn.net/weixin_40816738/article/details/103993664
