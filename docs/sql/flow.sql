...
-- ----------------------------
INSERT INTO `tbl_flow_listener` VALUES ('1418011167482535937', '测试任务监听器', 'taskListener', 'delegateExpression', '${taskListenerTest}', '测试任务监听器', 1);
INSERT INTO `tbl_flow_listener` VALUES ('1418011500015345666', '自动跳过执行监听', 'executionListener', 'delegateExpression', '${skipTaskListener}', null, 1);
INSERT INTO `tbl_flow_listener` VALUES ('1418011755431682049', '执行监听消息推送', 'executionListener', 'delegateExpression', '${sendMessageExecutionCallListener}', null, 1);
